...
| Offline P-256 authority proof v0 | candidate; promotion blocked | additive `house/task_spine/authority*.py` only | no upstream merge conflict | targeted signature, permission, time, tamper, replay, revocation, corruption, and split-database recovery fixtures; requires independent security review before real keys or production authority |
