...
| Offline P-256 authority proof v0 | council-accepted for design stage; promotion blocked | additive `house/task_spine/authority*.py` only | no upstream merge conflict | 3/3 local reviewers confirmed the sealed packet and accepted a separate ceremony-design stage; durable saga causality, journal anchoring, independent vectors, lifecycle recovery, and bounded rejection storage remain mandatory before real keys or production authority |
