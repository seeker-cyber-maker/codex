...
| Conserved event/session-tree thin slice | candidate | none; additive `house/context_tree` and schemas | no upstream merge conflict | 8 offline tests, Ruff, JSON, privacy, scope, and diff checks |
