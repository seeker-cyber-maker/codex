...
```text
TERM?       lexical agreement is needed
TERM=       working meaning for the named scope
TERM~       still ambiguous or deliberately deferred
```
...
restoration, and model/runtime replacement. Include ambiguous project terms
...
- reduces false agreement or repair cost compared with ordinary readable
  repair;
